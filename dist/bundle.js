...
module.exports = __webpack_require__.p + "3f34efc8e14570e9a5df583d62ff8966.mp3";

/***/ }),
/* 3 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "c3c86e71f309dde162a2e9b52cbc702f.mp3";

/***/ }),
/* 4 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "f3c18b98bab33c0fbedde9cb67bdfcf2.mp3";

/***/ }),
/* 5 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "f4a912ee52e2c884a80499208c5568cc.mp3";
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(6),p=__webpack_require__(7);__webpack_require__(8);var r=__webpack_require__(1);
...
*/
var aa=__webpack_require__(0);__webpack_require__(8);var l=__webpack_require__(13),n=__webpack_require__(6),ba=__webpack_require__(14),ca=__webpack_require__(1),da=__webpack_require__(7),ea=__webpack_require__(15),fa=__webpack_require__(16),ha=__webpack_require__(19),ia=__webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_normalize_css__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_App_css__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_sj_header__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_sj_pads__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_sj_options__ = __webpack_require__(29);
...
class App extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      null,
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_sj_header__["a" /* default */], null),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_sj_pads__["a" /* default */], {
        cpuSequence: this.state.cpuSequence,
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_sj_options__["a" /* default */], {
        cpuSequence: this.state.cpuSequence,
        active: this.state.active,
        gameOn: this.state.gameOn,
        turnCount: this.state.turnCount + 1,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_sj_header_css__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_sj_header_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__styles_sj_header_css__);
...
const Header = () => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
  ...
  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'h1',
    { className: __WEBPACK_IMPORTED_MODULE_1__styles_sj_header_css___default.a.heading },
    ' SIMON JOE:  MEMORY CAT'
  )
);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css__);




class Pads extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {

  showCpuSequence() {
    setTimeout(this.props.switchActive, 250);

    const runCpuSequence = value => new Promise(resolve => setTimeout(() => resolve(value === this.props.turnCount ? 'done' : 'no'), 500));

    const loop = value => runCpuSequence(value).then(result => {
      let cpuSequence = this.props.cpuSequence;
      let toggle = () => {
        if (cpuSequence[value] == 0) {
          document.getElementById(cpuSequence[value]).classList.toggle(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.cpu0);
        }
        if (cpuSequence[value] == 1) {
          document.getElementById(cpuSequence[value]).classList.toggle(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.cpu1);
        }
        if (cpuSequence[value] == 2) {
          document.getElementById(cpuSequence[value]).classList.toggle(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.cpu2);
        }
        if (cpuSequence[value] == 3) {
          document.getElementById(cpuSequence[value]).classList.toggle(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.cpu3);
        }
      };
      let sound = () => {
        if (cpuSequence[value] == 0) {
          let tone0 = new Audio(__webpack_require__(2));
          tone0.play();
        }
        if (cpuSequence[value] == 1) {
          let tone1 = new Audio(__webpack_require__(3));
          tone1.play();
        }
        if (cpuSequence[value] == 2) {
          let tone2 = new Audio(__webpack_require__(4));
          tone2.play();
        }
        if (cpuSequence[value] == 3) {
          let tone3 = new Audio(__webpack_require__(5));
          tone3.play();
        }
      };
  ...
  clickHandle(e) {
    ...
    if (this.props.active === 'plyr' && (plyrSequence.length - 1 < this.props.turnCount || this.props.turnCount === 0)) {

      let targ = e.currentTarget.id;
      let activate = () => {
        // Document.getElementById(targ).classList.toggle(styles.selected)
        if (targ == 0) {
          document.getElementById(targ).classList.toggle(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.plyr0);
        }
        if (targ == 1) {
          document.getElementById(targ).classList.toggle(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.plyr1);
        }
        if (targ == 2) {
          document.getElementById(targ).classList.toggle(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.plyr2);
        }
        if (targ == 3) {
          document.getElementById(targ).classList.toggle(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.plyr3);
        }
      };
      ...
      for (let i = 0; i < plyrSequence.length; i++) {
        ...
        if (plyrSequence[i] != cpuSequence[i] && this.props.strict === 'off') {
        ...
        if (plyrSequence[i] != cpuSequence[i] && i !== this.props.turnCount && this.props.strict === 'on') {
        ...
        if (i === this.props.turnCount) {
          if (plyrSequence[i] == cpuSequence[i] && this.props.turnCount < 19) {
          ...
          if (plyrSequence[i] != cpuSequence[i] && this.props.strict === 'on') {
            this.flushCpuSequence();
            this.showCpuSequence();
          }
        }
  ...
  padSelector() {
    if (this.props.gameOn === 'yes') {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { id: __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.padContainer },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { className: __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.row },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
            className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.pad, __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.zero),
            id: '0',
            onClick: this.clickHandle.bind(this)
          }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
            className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.pad, __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.one),
            id: '1',
            onClick: this.clickHandle.bind(this)
          })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          { className: __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.row },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
            className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.pad, __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.two),
            id: '2',
            onClick: this.clickHandle.bind(this)
          }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
            className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.pad, __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.three),
            id: '3',
            onClick: this.clickHandle.bind(this)
          })
        )
    ...
    if (this.props.gameOn === 'no') {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { className: __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.row },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.pad, __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.zero), id: '0' }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.pad, __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.one), id: '1' })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { className: __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.row },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.pad, __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.two), id: '2' }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()(__WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.pad, __WEBPACK_IMPORTED_MODULE_2__styles_sj_pads_css___default.a.three), id: '3' })
        )
      );
    }
...
/* harmony default export */ __webpack_exports__["a"] = (Pads);
...
// removed by extract-text-webpack-plugin
module.exports = {"padContainer":"-padContainer-","row":"-row-","pad":"-pad-","zero":"-zero-","one":"-one-","two":"-two-","three":"-three-","plyr0":"-plyr0-","plyr1":"-plyr1-","plyr2":"-plyr2-","plyr3":"-plyr3-","cpu0":"-cpu0-","cpu1":"-cpu1-","cpu2":"-cpu2-","cpu3":"-cpu3-"};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css__);



class Options extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  ...
  startGame() {
    ...
    let toggle = () => {
      if (cpuSequence[0] == 0) {
        document.getElementById(cpuSequence[0]).classList.toggle(__WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css___default.a.cpu0);
      }
      if (cpuSequence[0] == 1) {
        document.getElementById(cpuSequence[0]).classList.toggle(__WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css___default.a.cpu1);
      }
      if (cpuSequence[0] == 2) {
        document.getElementById(cpuSequence[0]).classList.toggle(__WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css___default.a.cpu2);
      }
      if (cpuSequence[0] == 3) {
        document.getElementById(cpuSequence[0]).classList.toggle(__WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css___default.a.cpu3);
      }
    };
  ...
  startGameStrict() {
    ...
    let activate = () => {
      ...
      document.getElementById(index).classList.toggle(__WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css___default.a.cpuSelected);
    };
    activate();
    setTimeout(activate, 500);
  ...
  optionsStateCheck() {
    if (this.props.gameOn === 'no') {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { id: __WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css___default.a.optionContainer },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'button',
          {
            className: __WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css___default.a.optionButton,
    ...
    if (this.props.gameOn === 'yes') {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { className: __WEBPACK_IMPORTED_MODULE_1__styles_sj_options_css___default.a.turnCounter },
...
// removed by extract-text-webpack-plugin
module.exports = {"cpu0":"-cpu0-","cpu1":"-cpu1-","cpu2":"-cpu2-","cpu3":"-cpu3-","optionContainer":"-optionContainer-","optionButton":"-optionButton-","turnCounter":"-turnCounter-"};
